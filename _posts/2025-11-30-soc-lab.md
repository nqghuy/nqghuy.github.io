---
title: "Xây dựng Web Server và SOC Homelab"
...
Bài viết chia sẻ quá trình xây dựng một web server và SOC homelab đơn giản tại nhà, bao gồm Wazuh (SIEM), Suricata (IDS) và Shuffle (SOAR - sắp triển khai).

## Tổng quan

Với một chiếc laptop cũ không sử dụng, mình quyết định tận dụng nó để xây dựng:
...
```
Sau đó chạy file auth_wazuh.exe
